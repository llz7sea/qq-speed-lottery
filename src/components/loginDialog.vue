  ...
  >
    ...
    <div class="loginDiv">
      <div class="login" id="login" style="height: 366px;">
        <div class="header"><a class="close" id="close" href="javascript:void(0);" title="关闭" tabindex="14"></a></div>
        <div class="error_tips" id="error_tips" style="display: none;"><span class="error_logo"
                                                                             id="error_logo"></span> <span
            class="err_m" id="err_m"></span></div>
        <div class="loading_tips" id="loading_tips"><span id="loading_wording">登录中</span><img id="loading_img"
        ...
        <div class="qlogin" id="qlogin" style="display: block;">
          ...
          <div class="qlogin_tips" id="qlogin_tips_3" style="display: none;">你已开启了设备锁安全登录服务，<br>请使用<a
              class="link_tips" href="http://im.qq.com/mobileqq/#from=login" target="_blank">QQ手机版</a>扫码进行登录。
          </div>
          ...
          <div class="qlogin_show" id="qlogin_show" style="width: 315px; left: 50%; margin-left: -157.5px;">
            <div class="qlogin_list" id="qlogin_list" style="width: 315px;"><span id="qr_area" class="qr_1"><img
                id="qrlogin_img" class="qrImg" alt=""
                src="@/assets/pic/ptqrshow.png"
                style=""> <span class="qrlogin_img_out" onmouseover="pt.plogin.showQrTips();"
                                onmouseout="pt.plogin.hideQrTips();"></span> <span id="qr_invalid" class="qr_invalid"
                                                                                   onclick="pt.plogin.begin_qrlogin();"
                                                                                   style="display: none;"><span
                id="qr_mengban" class="qr_mengban"></span> <span id="qr_invalid_tips"
                                                                 class="qr_invalid_tips"> 二维码失效 <br> 请点击刷新 </span></span></span><a
                hidefocus="true" draggable="false" href="javascript:void(0);" tabindex="2" uin="95478654" type="5"
                onclick="pt.qlogin.imgClick(this);return false;" onfocus="pt.qlogin.imgFocus(this);"
                onblur="pt.qlogin.imgBlur(this);" onmouseover="pt.qlogin.imgMouseover(this);"
                onmousedown="pt.qlogin.imgMouseDowm(this)" onmouseup="pt.qlogin.imgMouseUp(this)"
                onmouseout="pt.qlogin.imgMouseUp(this)" class="face"> <img id="img_95478654" uin="95478654" type="5"
                                                                           src="https://thirdqq.qlogo.cn/g?b=sdk&amp;k=k0W8ibDqSpcGibYO5yblvpjQ&amp;kti=Y9o4ywAAAAE&amp;s=100&amp;t=1555644955"
                                                                           onerror="pt.qlogin.imgErr(this);"> <span
                id="mengban_95478654"></span> <span class="uin_menban"></span> <span class="uin">95478654</span>
              <span id="img_out_95478654" uin="95478654" type="5" class="img_out"></span> <span id="nick_95478654"
                                                                                                  class="nick">95478654</span>
              <span class=""></span> <span class="onekey_logo"></span> </a></div>
          </div>
          <div class="guanjia hide"><img class="guanjia_logo hide"
                                         src="//imgcache.qq.com/ptlogin/v4/style/40/images/logo.png"><input
              type="checkbox" class="guanjia_checkbox hide"><span class="guanjia_tips"></span></div>
          <a title="下一页" class="nextPage" id="nextPage" href="javascript:void(0);" style="display: none;"><span
              class="nextRow" tabindex="7"></span></a></div>
          ...
          <div class="web_qr_login_show" id="web_qr_login_show">
            <div class="web_login" id="web_login">
              <div class="tips" id="tips">
                ...
                <div class="title" id="title_2" @click="checkToPwd">密码登录</div>
                <div id="qlogin_entry">推荐使用<a class="switch_btn_focus link_tips" hidefocus="true" id="switcher_qlogin"
                                              href="javascript:void(0);" tabindex="7">快捷登录</a>，防止盗号。
                </div>
              ...
              <div class="login_form">
                <form id="loginform" autocomplete="off" name="loginform" action="" method="post" target="1"
                  ...
                  <div class="uinArea" id="uinArea"><label class="input_tips" id="uin_tips" for="u" data-onlyqq="QQ号码"
                    ...
                    <div class="inputOuter"><input type="text" class="inputstyle" id="u" name="u" value=""
                  ...
                  <div class="pwdArea" id="pwdArea"><label class="input_tips_focus" id="pwd_tips" for="p"
                    ...
                    <div class="inputOuter" id="pwdAreaInputOuter"><input type="password" class="inputstyle password"
                                                                          id="p" name="p" value="" maxlength="16"
                                                                          tabindex="2"></div>
                  ...
                  <div class="verifyArea" id="verifyArea">
                    ...
                    <div class="verifyimgArea" id="verifyimgArea"><img class="verifyimg" id="verifyimg"
                                                                       title="看不清，换一张"> <a tabindex="4"
                                                                                           href="javascript:void(0);"
                                                                                           class="verifyimg_tips">看不清，换一张</a>
                    </div>
                  </div>
                  <div class="submit"><a class="login_button" href="javascript:void(0);" hidefocus="true"><input
                      type="submit" tabindex="6" value="登录" class="btn" id="login_button"></a></div>
                </form>
              </div>
              <div class="guanjia hide"><img class="guanjia_logo hide"
                                             src="//imgcache.qq.com/ptlogin/v4/style/40/images/logo.png"><input
            ...
            <div class="bottom" id="bottom_web"><a href="https://ssl.ptlogin2.qq.com/ptui_forgetpwd" class="link"
                                                   id="forgetpwd" target="_blank">找回密码</a> <span
                class="dotted"></span> <a href="https://ssl.ptlogin2.qq.com/j_newreg_url" class="link"
                                          target="_blank">注册帐号</a> <span class="dotted"></span> <a class="link"
                                                                                                   id="feedback_web"
        ...
        <div id="onekey_step2" class="onekey_step2">
          <div class="outer">
            ...
            <div class="container">
              ...
              <div class="operate"> 没有收到登录确认？请<a
                  href="javascript:pt.qlogin.onekeyPush(pt.qlogin.__onekeyUin)">重新发送。</a></div>
        ...
        <div class="bottom hide" id="bottom_qlogin" style="display: block;"><a class="link" hidefocus="true"
                                                                               id="switcher_plogin"
                                                                               href="javascript:void(0);"
                                                                               tabindex="8">密码登录</a> <span
            class="dotted" id="docs_dotted"></span> <a href="https://ssl.ptlogin2.qq.com/j_newreg_url" class="link"
                                                       target="_blank">注册帐号</a> <span class="dotted"></span> <a
            class="link" id="feedback_qlogin" href="https://support.qq.com/products/14800" target="_blank">意见反馈</a>
        </div>
        <div id="authLogin" class="authLogin">
          <div class="authHeader" id="authHeader">
            <div class="logo"></div>
            <span class="title">腾讯业务</span></div>
          <div class="authTips"></div>
          <div class="authWording"><span><span>点击头像，确认帐号登录</span><span>腾讯业务</span></span></div>
          <div class="authInfo"><a class="face" id="auth_area" tabindex="1" href="javascript:void(0);"
                                   draggable="false" hidefocus="true"><img id="auth_face"> <span id="auth_mengban"
                                                                                                 class=""></span>
...
.error_tips, .loading_tips, .login_no_qlogin .header .switch .switch_bottom, .login_no_qlogin .header .switch .switch_btn {
  display: none
}
...
.web_login .inputOuter, .web_login .inputOuter_focus {
  width: 250px;
  height: 38px
}
...
.qlogin .face .img_out, .qlogin .face .img_out_focus, .qlogin .face:hover .img_out {
  width: 85px;
  height: 85px;
  position: absolute;
  left: 9px;
...
.qlogin .face .img_out, .qlogin .face .img_out_focus {
  background: 0 0;
...
.qlogin .qr_0 .qrlogin_img_out, :root .qlogin .qr_0 .qr_mengban {
  filter: none \9
}
...
.qlogin .qr_1 .qrlogin_img_out, :root .qlogin .qr_1 .qr_mengban {
  filter: none \9
}
...
.bottom.center, .docsqq .bottom, .guanjia, .title {
  text-align: center
}
